...
const handleAddAnnouncement=async (req, res) => {
  ...
  const handleDeleteAnnouncement=async (req, res) => {
    try {
      ...
      const deleteMessage = await messageModel.findByIdAndUpdate(messageId,
        { $set: { deleted: true } },
        { new: true }
        );
  ...
  module.exports={handleAddAnnouncement,handleGetAnnouncements,handleDeleteAnnouncement}